...
class _JuicePageState extends State<JuicePage> {
  ...
  final List<Map<String, String>> trendingStores = [
    {"image": "assets/images/Fresh Juice.jpg", "title": "Fresh Juice"},
    {"image": "assets/images/Go Fresh Juice.jpg", "title": "Go Fresh Juice"},
    {"image": "assets/images/Linda's Juice Bar.jpeg", "title": "Linda's Juice"},
    {"image": "assets/images/So Fresh Juice.jpg", "title": "So Fresh Juice"},
  ];

  final List<Map<String, String>> awesomeLocalStores = [
    {"image": "assets/images/Ah Pha Luk Tuek Kroch Pursat.jpg", "title": "Tuek Kroch Pursat"},
    {"image": "assets/images/Apple Fresh.jpg", "title": "Apple Fresh"},
    {"image": "assets/images/Heng Heng.jpg", "title": "Heng Heng"},
    {"image": "assets/images/Jing Jing Fresh Juice.jpg", "title": "Jing Fresh Juice"},
  ];
